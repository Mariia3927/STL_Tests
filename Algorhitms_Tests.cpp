...
TEST(sort_array_using_sort_function, sort)
{
...
TEST(sort_array_of_user_defined_type, sort)
{
...
TEST(sort_part_of_the_array, partial_sort)
{
    int mas[] = {7, 3, 90, 25, 67, 34, 1, 87, 0, 45, 99, 2, 15, 76, 45, 0, 25, -7, 37, 19, -45, 12, 90, -67, 82, 5, 43, -56, 78, 0, 33, 71, -6, 89, -45, 81, 29, -8, 0, 38, 44, -71, 98, 53, -65, 88, 39, 27, 17, -69, 0, 47, 19, 77, -24, 0, 55, 73, 68, 54, -71, 15, 0, 40, 32, 13, 0, -51, 90, 44, 17, -93, 58, 69, 34, 0, 55, 22, 11, 99, 100, -58, 7, 3, 90, 25, 67, 34, 1, 87, 0, 45, 99, 2, 15, 76, 45, 0, 25, -7};
...
TEST(sort_part_of_the_array_using_lambda_as_compare_parameter, partial_sort)
{
    int mas[] = {7, 3, 90, 25, 67, 34, 1, 87, 0, 45, 99, 2, 15, 76, 45, 0, 25, -7, 37, 19, -45, 12, 90, -67, 82, 5, 43, -56, 78, 0, 33, 71, -6, 89, -45, 81, 29, -8, 0, 38, 44, -71, 98, 53, -65, 88, 39, 27, 17, -69, 0, 47, 19, 77, -24, 0, 55, 73, 68, 54, -71, 15, 0, 40, 32, 13, 0, -51, 90, 44, 17, -93, 58, 69, 34, 0, 55, 22, 11, 99, 100, -58, 7, 3, 90, 25, 67, 34, 1, 87, 0, 45, 99, 2, 15, 76, 45, 0, 25, -7};
    int sortedPartOfMas[] = {-93,-71,-71,-69,-67,-65,-58,-56,-51,-45,-45,-24,-8,-7,-7,-6,0,0,0,0};
...
TEST(sort_part_of_the_array_using_nth_element, nth_element)
{
    int mas[] = {7, 3, 90, 25, 67, 34, 1, 87, 0, 45, 99, 2, 15, 76, 45, 0, 25, -7, 37, 19, -45, 12, 90, -67, 82, 5, 43, -56, 78, 0, 33, 71, -6, 89, -45, 81, 29, -8, 0, 38, 44, -71, 98, 53, -65, 88, 39, 27, 17, -69, 0, 47, 19, 77, -24, 0, 55, 73, 68, 54, -71, 15, 0, 40, 32, 13, 0, -51, 90, 44, 17, -93, 58, 69, 34, 0, 55, 22, 11, 99, 100, -58, 7, 3, 90, 25, 67, 34, 1, 87, 0, 45, 99, 2, 15, 76, 45, 0, 25, -7};
    int sortedPartOfMas[] = {-93,-71,-71,-69,-67,-65,-58,-56,-51,-45,-45,-24,-8,-7,-7,-6,0,0,0,0};
...
TEST(sort_part_of_the_array_using_nth_element_and_compare_function, nth_element)
{
    int mas[] = {7, 3, 90, 25, 67, 34, 1, 87, 0, 45, 99, 2, 15, 76, 45, 0, 25, -7, 37, 19, -45, 12, 90, -67, 82, 5, 43, -56, 78, 0, 33, 71, -6, 89, -45, 81, 29, -8, 0, 38, 44, -71, 98, 53, -65, 88, 39, 27, 17, -69, 0, 47, 19, 77, -24, 0, 55, 73, 68, 54, -71, 15, 0, 40, 32, 13, 0, -51, 90, 44, 17, -93, 58, 69, 34, 0, 55, 22, 11, 99, 100, -58, 7, 3, 90, 25, 67, 34, 1, 87, 0, 45, 99, 2, 15, 76, 45, 0, 25, -7};
    int sortedPartOfMas[] = {-93,-71,-71,-69,-67,-65,-58,-56,-51,-45,-45,-24,-8,-7,-7,-6,0,0,0,0};
...
TEST(split_the_array_on_even_and_odd_values, partition)
{
...
TEST(find_min_element_in_the_array, min_element)
{
    int mas[] = {7, 3, 90, 25, 67, 34, 1, 87, 0, 45, 99, 2, 15, 76, 45, 0, 25, -7, 37, 19, -45, 12, 90, -67, 82, 5, 43, -56, 78, 0, 33, 71, -6, 89, -45, 81, 29, -8, 0, 38, 44, -71, 98, 53, -65, 88, 39, 27, 17, -69, 0, 47, 19, 77, -24, 0, 55, 73, 68, 54, -71, 15, 0, 40, 32, 13, 0, -51, 90, 44, 17, -93, 58, 69, 34, 0, 55, 22, 11, 99, 100, -58, 7, 3, 90, 25, 67, 34, 1, 87, 0, 45, 99, 2, 15, 76, 45, 0, 25, -7};
...
TEST(find_min_temperature, min_element)
{
...
TEST(find_max_temperature, max_element)
{
...
TEST(find_min_from_two_values, min)
{
    int a = 27, b = 28;
    EXPECT_EQ(std::min(a, b), 27);
}

TEST(find_min_temperature_with_compare_object, min)
{
    Weather today(12, 2);
...
TEST(find_max_from_two_values, max)
{
    int a = 27, b = 28;
    EXPECT_EQ(std::max(a, b), 28);
}

TEST(find_max_temperature_with_compare_object, max)
{
    Weather today(12, 2);
    Weather yesterday(10, 3);
