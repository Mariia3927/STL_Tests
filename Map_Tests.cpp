...
TEST(indexing_operator, single_element_insert_with_indexing_operator)
{
...
TEST(indexing_operator, change_value_by_the_key_with_indexing_operator)
{
    std::map<char, std::string> fruits;
...
TEST(insert, single_element_insert_function)
{
    std::map<char, std::string> fruits;
...
TEST(insert, single_element_insert_function_by_equal_key)
{
    std::map<char, std::string> fruits;
...
TEST(insert, single_value_insert_function_with_hint)
{
    std::map<char, std::string> fruits;
...
TEST(insert, insert_range_of_elements)
{
...
TEST(insert, insert_range_with_keys_existed_in_the_destination_map)
{
    std::map<char, std::string> fruitsForInserting;
...
TEST(emplace, emplace_single_value_to_map)
{
    std::map<char, std::string> fruits;
...
TEST(emplace, emplace_single_value_with_key_existed_in_map)
{
    std::map<char, std::string> fruits;
...
TEST(emplace_hint, emplace_single_value_with_hint_to_map)
{
    std::map<char, std::string> fruits;
...
TEST(erase, erase_single_element_by_iterator)
{
    std::map<char, std::string> fruits;
...
TEST(erase, erase_single_element_by_key)
{
    std::map<char, std::string> fruits;
...
TEST(erase, erase_range_of_elements)
{
    std::map<char, std::string> fruits;
...
TEST(find, find_existing_element_in_map)
{
    std::map<char, std::string> fruits;
...
TEST(find, find_non_existing_element_in_map)
{
    std::map<char, std::string> fruits;
...
TEST(find, struct_as_key_in_map)
{
